...
INSERT INTO professors (alias, name, office, course) VALUES
  ('oka', 'Oka Kurniawan', '1.307', '50.002'),
  ('zy', 'Zhang Yue', '1.703', '50.002'),
  ('norman', 'Norman Lee', '1.407', '50.001')
  ON CONFLICT (alias, name) DO NOTHING;